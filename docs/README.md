...
Projecto desenvolvido no âmbito académico da disciplina de Arquitectura e Desenho de Software do Mestrado em Informática da UMAIA.

---

## Nota sobre Utilização de IA

Foi utilizado o Claude AI (Anthropic) como ferramenta de apoio ao desenvolvimento e aprendizagem. A concepção, decisões técnicas e implementação foram da responsabilidade do aluno, com a IA a servir como auxiliar para esclarecimento de conceitos e boas práticas de Django.